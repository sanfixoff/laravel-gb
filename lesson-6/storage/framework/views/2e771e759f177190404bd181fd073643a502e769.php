                        ...
                        <form
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="text" id="newsText"
                                          class="form-control"><?php echo e($news->text ?? old('text')); ?></textarea>
                            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\dz\resources\views/admin/create.blade.php ENDPATH**/ ?>